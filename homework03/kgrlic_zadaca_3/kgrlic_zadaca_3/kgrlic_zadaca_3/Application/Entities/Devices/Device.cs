...
namespace kgrlic_zadaca_3.Application.Entities.Devices
{
    abstract partial class Device
    {
        ...
        public abstract Device DeepClone();
        ...
        public int UniqueIdentifierNN => UniqueIdentifier ?? 0;
        ...
        public override string ToString()
        {
            return
                ...
                + ", max: " + Max 
                + ", komentar:" + Comentary
                + ", konacna vrijednost:" + ReadValue()
                + ", koristen:" + (IsBeingUsed ? "Da" : "Ne")
                + ", komentar:" + Comentary
                + ", pogresaka:" + StatusHistory.FindAll(s => s == 0).Count
                + ", pouzdanost:" + ((1 - ((float)StatusHistory.FindAll(s => s == 0).Count / StatusHistory.Count)) * 100).ToString("N2") + "%"
                + " }";
        }
